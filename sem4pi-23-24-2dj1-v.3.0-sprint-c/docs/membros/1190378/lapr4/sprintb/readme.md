# 1190378 - André Ferreira - Sprint B - Self Assessment
...
I followed the engineering process for the elaboration of the domain model and glossary. Choose level 4 because I think there is always room for improvement.
But with the domain model and glossary the correct approach and good practices of software engineering were applied.
...
**Justification and Evidences:**
I choose level 4 here because not every commit could be associated with the github issues. However correct version control practices were applied, such
as pulling before pushing, commenting commits, and frequently commiting.
...
**Justification and Evidences:**
The evidences of the teamwork are itself present on the amount of commits by each member. There were no conflicts and during the classes there was always open
communication about the task being achieved. Specially when designing the domain model.
## Deployment
...
**Justification and Evidences:**
There was no deployment this sprint.
...
**Justification and Evidences:**
Correct integration was assured through the proper setup of the pom.xml and run scripts.
...
**Justification and Evidences:**
The requirements specified in the system document were correctly achieved. 