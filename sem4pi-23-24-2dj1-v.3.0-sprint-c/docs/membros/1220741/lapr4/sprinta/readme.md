# 1220741 - Bernardo Barbosa - Sprint A - Self Assessment
...
The Level 4 rating is justified because we thoroughly followed the order of the engineering process, updating the domain model and glossary simultaneously as they depend on each other to make sense. 
An example of that follows the synchronized commits of DM and glossary in 7/04/2024 by me (1220741) and Diogo (122071) respectively. 
...
I did choose 5 Rating because I documented every task/issue with concise and proper commit messages. There were almost no conflicts and my commits did not cause any interference with others work , as they were synchronized.
I used the files name (Ex glossary.md updated) to better specify  and get the understanding of other team members.
...
**Justification and Evidences: Each big as small decision was decided as group before putting into action.Team cohesion was assures as well as proper communication.**
...
**Justification and Evidences: Proper Documentation and Integration with other components were correctly assigned without incoherence assured. Although there were not many tasks applicable to this Sprint.**
...
Our team  designed the domain model in accordance to the requirements, taking into account all the future sprints and possibilities. We believe our solution can provide all the context necessary for understanding and representing of the business Model.

**Note: A lot of the criteria for this evaluation is inapplicable to this Sprint.**
