# 1221285 - António Costa - Sprint A - Self Assessment
...
The Level 5 rating is justified because we thoroughly followed the order of the engineering process, updating the domain model and glossary simultaneously as they depend on each other to make sense. 
...
The Level 5 rating is justified because we have exceptionally thorough documentation and in terms of Integration, there's not many tasks applicable to this Sprint.
...
Our team designed the domain model in accordance to the requirements, taking into account all the future sprints and possibilities. We believe our solution can provide all the context necessary for understanding and creating the program.
