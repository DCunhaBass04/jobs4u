# 1221071 - Diogo Cunha - Sprint A - Self Assessment
...
This Level 5 is justified since every decision made has documentation and every commit has a significant message.
...
**Justification and Evidences:**
This Level 4 is justified since commits were done correctly, but there were some that resulted in merges, and one member of the team lost access to his *GitHub* account and had to send his progress to another member.
...
**Justification and Evidences:**
This Level 4 is justified since the commits and the consistency between the group show coherence between members.
